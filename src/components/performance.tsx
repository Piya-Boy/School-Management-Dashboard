...
<div className="bg-white dark:bg-slate-700 p-4 rounded-md h-80 relative">
      ...
      <div className="absolute top-1/2 left-1/2 dark:text-gray-400 transform -translate-x-1/2 -translate-y-1/2 text-center">
        <h1 className="text-3xl font-bold ">9.2</h1>
        <p className="text-xs text-gray-500">of 10 max LTS</p>
      </div>
      <h2 className="font-medium absolute bottom-16 left-0 right-0 m-auto text-center dark:text-gray-400">1st Semester - 2nd Semester</h2>
    </div>
  )
}
